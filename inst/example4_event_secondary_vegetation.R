...
file_json = "./inst/area_Sinop/part_Sinop_classification_14patterns_3bands.json"

input_tb_area_Sinop <- file_json %>% 
  stilf_fromJSON() 
...
area_tb <- stilf_standard_date_events(data_tb = new_area_Sinop, month_year = "09", day_month = "01")
