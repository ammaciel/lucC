...
# see maps
stilf_plot_maps_input(itanhanga_TWDTW.tb, EPSG_WGS84 = TRUE, custom_palette = FALSE) 
...
itanhanga_TWDTW.tb <- get(load("~/Desktop/ESTUDO_TESE/Studies/Itanhanga/itanhanga_TWDTW_stilf.tb.RData"))
itanhanga_TWDTW.tb
...
itanhanga_TWDTW_new_date.tb <- stilf_standard_date_events(data_tb = itanhanga_TWDTW.tb, month_year = "09", day_month = "01")
...
stilf_plot_maps_input(itanhanga_TWDTW_new_date.tb, EPSG_WGS84 = TRUE, custom_palette = FALSE) 

stilf_plot_maps_input(df, EPSG_WGS84 = TRUE, custom_palette = TRUE, RGB_color = c("#9b7447", "#FFB266", "#1b791f", "#929e6e", "#f5e7a1"))#,"#00bfff")) # , "#66CC00" secondary_vegetation
...
stilf_plot_maps_input(df_label_2, EPSG_WGS84 = TRUE, custom_palette = TRUE, RGB_color = c("#9b7447", "#1b791f", "#929e6e", "#f5e7a1", "#FFB266")) # , "#66CC00" secondary_vegetation
#dev.off()

#stilf_toGeoTIFF(df, path_raster_folder = "~/Desktop/raster/")

#png(filename = "~/Desktop/fig2_area_eve.png", width = 7, height = 7, units = 'in', res = 300)
stilf_plot_maps_events(data_sec_veg_occurs, EPSG_WGS84 = TRUE, custom_palette = TRUE, RGB_color = c("#9b7447", "#1b791f", "#929e6e", "#f5e7a1", "#FFB266"), size_square = 1.5)# 0.000001) 
...
stilf_plot_maps_input(df_label, EPSG_WGS84 = TRUE, custom_palette = TRUE, RGB_color = c("#9b7447", "#FFB266", "#1b791f", "#929e6e",  "#f5e7a1")) 
#dev.off()
